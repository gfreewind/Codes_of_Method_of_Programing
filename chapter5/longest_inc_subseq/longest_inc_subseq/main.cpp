...
int main()
{
	...
	print_result(ret);
	ret.clear();
	longest_inc_subseq_by_common_sub(a1, sizeof(a1) / sizeof(a1[0]), ret);
	print_result(ret);
	...
	print_result(ret);
	ret.clear();
	longest_inc_subseq_by_common_sub(a2, sizeof(a2) / sizeof(a2[0]), ret);
	print_result(ret);
	...
	print_result(ret);
	ret.clear();
	longest_inc_subseq_by_common_sub(a3, sizeof(a3) / sizeof(a3[0]), ret);
	print_result(ret);
